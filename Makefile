...
$(PROJECT_NAME): $(OBJS)
	$(CC) -o ${BUILD_OUT_DIR}/$(PROJECT_NAME)$(EXT) ${subst src/,obj/, $(OBJS)} $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
